...
final class MethodBodyPatcher {
    private MethodBodyPatcher() { }

    static String methods(byte[] bytecode, ClassLoader loader) throws Exception {
    ...
    static byte[] patch(byte[] bytecode, ClassLoader loader, String name, String descriptor,
