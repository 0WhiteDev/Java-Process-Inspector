...
final class ApiHookManager {
    ...
    ApiHookManager(Instrumentation instrumentation, ClassRegistry registry) {
        this.instrumentation = instrumentation;
        this.registry = registry;
    }

    synchronized String start(String payload) throws Exception {
